...
Artifact Evaluation will be carried out by core contributors of Black Sky Society, based on Creativity, Aesthetics, and Reasoning. For context, refer to the Black Sky Society visual universe. You have the freedom to deviate from this - we will accept things that we find generally beautiful and inspiring. 
