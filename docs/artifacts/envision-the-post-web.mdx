---
sidebar_position: 1
sidebar_label: 'Black Sky Society Invites You to Envision the Post-Web'
description: 'Three $500 Rewards for Best Artifact'
image: /img/artifacts/AE2deity2.png
tags: [Post-Web]
---
...
<span class="doc-subtitle">Two $1000 Rewards for Best Artifact</span>
...
We invite you to participate in the conversation happening at AE2 on July 16th in Paris, even if you can’t attend the event, **by acting as the architects envisioning a new internet via the creation of an original work in the form of a story/article or music video**. All entrants have the opportunity for their Artifact to be shared at AE2, as well as being rewarded $1000 for the Best Artifact in each medium (written, music video), but there will also be runners-up. Original works are to be based on the prompt directly below.  
...
* Post your artifact on Twitter and use the hashtags #PostWebArtifact #AE2 and also mention [@BlackSkySociety](https://twitter.com/BlackSkySociety)
* After you have done that, add your submission to [this forum post](https://forum.blacksky.network/t/envision-the-post-web-artifact-submission) or alternatively email it to `nexuseditors@blacksky.network`. In the submission, include: a link to your Tweet, raw files of your artifacts, your name or pseudonym, a short bio (280 characters),  and your Ethereum address to receive the best artifact reward and/or remuneration for potential Artifact auction.

If you have questions, feel free to [post them here](https://forum.blacksky.network/t/envision-the-post-web-questions-answers/22) or email `nexuseditors@blacksky.network`.

## Join us in Paris on July 16th
Either way, we hope that you will join us at Autonomous Ecologies #2 in Paris. [Follow this wormhole](https://autonomousecologies.xyz/) more details and registration.
