...
### Production Stage
Penumbra is currently in the testnet stage of product development, with no plans incentivized testnets.  Penumbra Labs originally aimed to launch Penumbra on mainnet by the end of 2022 [^15], but the new launch target appears to be the end of this year[^13].

Penumbra Labs releases new tesnet versions biweekly, with testnets named after Jupiter's moons. The 51st testnet, Elara, was released on April 24, 2023[^16].
...
*Ephemeral Addresses for Public Interactions* has been added to our work-in-progress [Post-Web Pattern Library](../../wiki/Post-Web%20Patterns/ephemeral-addresses). More details on what we mean regarding the Post-Web will be provided in the future.
:::
...
[^1]: Penumbra.zone. "Penumbra - Team." Accessed April 2023. https://penumbra.zone/team/
