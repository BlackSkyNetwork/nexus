...
image: /img/00000001/headers/anoma2.jpeg
...
The [v3](https://specs.anoma.net/main/releases/v3.html) of Anoma is quite necessary to fulfill on the mission of creating a “privacy-preserving protocol”, so hopefully there is no mainnet Anoma until v3 is released, so the user experience can be well tailored to properly satisfy their mission.
