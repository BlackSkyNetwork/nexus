...
# Anoma Protocol
<span class="doc-subtitle">Project overview & cypherpunk analysis</span>
...
Anoma is being developed by Heliax AG (Heliax), who are the founding development team funded by the Anoma Foundation, the latter of whom raised a $6.8m seed round in January 2021 and a $26m follow-on round in November 2021, valuing Anoma at $260m. [^2]
...
Anoma has broad goals for intents to be used for the bartering of goods and services in local physical communities [^3], but there are currently no technical designs for how to realistically establish such barter economies.
...
In initial versions of Anoma, such as [v1](https://specs.anoma.net/main/releases/v1.html), validity predicate functions are public meaning when a user is customizing their validity predicates, Anoma will leak data around balance preferences and transaction threshold amounts that require greater security. In later versions, [v3](https://specs.anoma.net/main/releases/v3.html), once the full spec of Taiga is devised, developed, and released, it will be possible to have validate predicates with private functions that support multi-party transactions. 
...
If you appreciated this research and would like to see more like it, please consider making a donation to [Black Sky Nexus](https://www.blacksky.network/#support). Additionally, follow Black Sky on [Twitter](https://twitter.com/BlackSkyNetwork) or join our [social space](https://discord.com/invite/TrFzBxzCHH). 
:::
