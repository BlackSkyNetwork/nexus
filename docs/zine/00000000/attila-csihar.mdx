...
title: 'Attila Csihar Channels Dark Saturnalian Energy'
description: 'An avant-garde performance exploring extraterrestrial intelligence'
image: /img/00000000/headers/attila.png
---
import ImgUp from '@site/static/img/dec_up.svg';
import ImgDown from '@site/static/img/dec_down.svg';


# Attila Csihar Channels Dark Saturnalian Energy
<span class="doc-subtitle">An avant-garde performance exploring extraterrestrial intelligence</span>
