...
###### Art as Generative Source for knowledge
...
###### Enter the Wormhole
We have prepared Black Sky Nexus: `Issue 00000000` and we invite you to peruse it. We also welcome and invite individuals and communities to join our [Discord](https://discord.gg/TrFzBxzCHH) and discuss the articles or contribute to Black Sky Nexus. We are especially seeking writers, researchers, translators and designers to join our collective. A DAO launch is on the horizon, as is a transition to more privacy preserving chat tools for internal operations. Lastly, if you purchase an NFT from the featured artists, 50% of the profits go toward Black Sky Nexus, and you'll be invited first to join the Black Sky DAO.
...
_We’re so grateful to DAOSquare and MolochDAO for the grants that gave Black Sky the momentum to deliver this resource._
